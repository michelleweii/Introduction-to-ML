...
print('ture:',labels_true)
k_means = KMeans(init = "k-means++", n_clusters = 3, n_init = 10)
t0 = time.time()
k_means.fit(X)
t_batch = time.time() - t0
k_means_labels = k_means.labels_
print('kmeans:',k_means_labels)
...
print('mbk_means_cluster_centers',mbk_means_cluster_centers)
order = pairwise_distances_argmin(k_means_cluster_centers, mbk_means_cluster_centers)
print('order:',order)
print('mbk_means_labels_unique',mbk_means_labels_unique)
